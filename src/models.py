...
class Documento(Base):
    ...
    paginas_ocr: Mapped[int] = mapped_column(
        Integer,
        default=0,
    )
...
class Atendimento(Base):
    """Representa um atendimento extraído de um documento."""
    ...
    solicitante: Mapped[str | None] = mapped_column(
        String(160),
        nullable=True,
    )
    ...
    solucao: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
    )

    tempo_minutos: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
    )
    ...
    motivos: Mapped[str | None] = mapped_column(
        Text,
        nullable=True,
    )
    ...
    texto_limpo: Mapped[str] = mapped_column(
        Text,
    )
...
class Chunk(Base):
    """Representa um trecho de texto usado no RAG."""
...
class ErroProcessamento(Base):
    """Registra erros ocorridos durante o processamento."""
